 ...
 * See <a href="https://docs.oracle.com/javase/8/docs/technotes/guides/security/troubleshooting-security.html">https://docs.oracle.com/javase/8/docs/technotes/guides/security/troubleshooting-security.html</a> for all options.
 */
public class SenderVerifiesBankIDStatusIT {
    ...
    public void happyDayScenario() throws Exception {
        ...
        VerifiedSignature signature = verifiedSignature.get();
